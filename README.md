...
[![Build](https://github.com/romoney5/yt-dlpd/actions/workflows/build.yml/badge.svg)](https://github.com/romoney5/yt-dlpd/actions/workflows/build.yml)

</div>
<!-- MANPAGE: END EXCLUDED SECTION -->

yt-dlpd is a [yt-dlp](https://github.com/yt-dlp/yt-dlp) fork based on the now inactive [youtube-dlc](https://github.com/blackjack4494/yt-dlc). The main focus of this fork is having all the commits that the original enjoys while pushing builds more regularly
